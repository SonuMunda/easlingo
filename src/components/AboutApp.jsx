const AboutApp = () => {
    return (
      <section className="home-about bg-gray-900 py-12 px-8">
        <div className="container mx-auto px-4">
          ...
          <h3 className="text-xl text-gray-400 font-bold mb-4">Key Features:</h3>
          <ul className="list-disc list-inside text-lg text-gray-500 mb-6">
          ...
          <h3 className="text-xl text-gray-400 font-bold mb-4">How It Works:</h3>
          <p className="text-lg text-gray-500 leading-relaxed mb-6">
          ...
          <h3 className="text-xl  text-gray-400 font-bold mb-4">Why Choose Our App:</h3>
          <ul className="list-disc list-inside text-lg text-gray-500 mb-6">
